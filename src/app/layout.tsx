...
const themeInitScript = `(function(){try{var k='brandmypiano-theme';var p=localStorage.getItem(k);if(p!=='default'&&p!=='dark'&&p!=='system')p='default';var t=p;if(p==='system'){t=window.matchMedia('(prefers-color-scheme: dark)').matches?'dark':'light'}var r=document.documentElement;r.setAttribute('data-theme',t);r.setAttribute('data-theme-preference',p);}catch(e){document.documentElement.setAttribute('data-theme','default');document.documentElement.setAttribute('data-theme-preference','default');}})();`;
